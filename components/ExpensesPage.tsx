...
export default function ExpensesPage() {
  ...
  const refresh = () => {
    ...
    Promise.all([
      ...
      async ([exps, inv, monthly, byCat, ytd, cyc]) => {
        setExpenses(exps);
        setInventory(inv);
    ...
    <div className="space-y-6 pb-20">
        ...
        <div>
          ...
          {loading ? (
            ...
            <div className="deck-card-bg deck-border-thick rounded-xl border-[#00ffaa]/20 p-12 text-center">
              <p className="font-mono text-[#9a9aa3]">No inventory yet. Log a peptide expense and add to inventory.</p>
              <button
                type="button"
                onClick={() => setModalOpen(true)}
      ...
      {tab === "reports" && (
        <div className="space-y-8">
          ...
          <div className="deck-card-bg deck-border-thick rounded-xl border-[#00ffaa]/20 p-4">
            <h3 className="font-mono text-sm font-bold text-[#00ffaa] mb-4">Monthly spending (last 6 months)</h3>
            <div className="h-64 w-full">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <XAxis dataKey="name" stroke={chartTheme.text} tick={{ fontFamily: "monospace", fontSize: 10 }} />
                  <YAxis stroke={chartTheme.text} tick={{ fontFamily: "monospace", fontSize: 10 }} tickFormatter={(v) => `$${v}`} />
                  <Tooltip
                    contentStyle={{ backgroundColor: "#0a0e1a", border: "1px solid rgba(0,255,170,0.4)", borderRadius: 8 }}
          ...
          <div className="deck-card-bg deck-border-thick rounded-xl border-[#00ffaa]/20 p-4">
            <h3 className="font-mono text-sm font-bold text-[#00ffaa] mb-4">Spending by category (YTD)</h3>
